...
if game:GetService("CoreGui"):FindFirstChild("R2lxHub") then
    game:GetService("CoreGui"):FindFirstChild("R2lxHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Blox Fruit | https://discord.com/invite/V9xq5t5UhM          [RightControl]"
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    function uitab:AddTab(text,img)
        ...
        NotificationHold.BackgroundColor3 = Color3.new(0, 0, 255)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(0, 0, 255)
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropScroll.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
        ...
        DropButton.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
        ...
        RealTextbox.Font = Enum.Font.GothamSemibold
        RealTextbox.Text = ""
        RealTextbox.TextColor3 = Color3.fromRGB(0, 0, 255)
        RealTextbox.TextSize = 11.000
        RealTextbox.TextTransparency = 0
    ...
    function main:AddSeperator(text)
        ...
        Sep1.BackgroundColor3 = Color3.new(0, 0, 255)
        ...
        Sep3.BackgroundColor3 = Color3.new(0, 0, 255)
    ...
    function main:AddLine()
        ...
        Line.Name = "Line"
        Line.Parent = Linee
        Line.BackgroundColor3 = Color3.new(0, 0, 255)
        Line.BorderSizePixel = 0
...
function UpdateRealFruitChams() 
	for i,v in pairs(game.Workspace.R2lxSpawner:GetChildren()) do
		if v:IsA("Tool") then
...
local Library = Update:Window("R2lx Hub","",Enum.KeyCode.RightControl);
...
NguyenTien:AddLabel("Owner: DucLuong")
NguyenTien:AddLabel("Support Code: DucLuong")
...
setclipboard("https://discord.com/invite/V9xq5t5UhM")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("profile",function()
setclipboard("https://vercel.app/luongskibidi")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
NguyenTien:AddButton("Facebook Official Owner",function()
setclipboard("https://www.facebook.com/luongdaynetroi")
Notif.New("Copying To Clipboard DoneðŸŽ‰", 3)
end)
---- Trang Chá»§
